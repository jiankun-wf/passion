...
import verticalImg from './image/middlecontrol.svg';
import horizontalImg from './image/middlecontrolhoz.svg';
import edgeImg from './image/edgecontrol.svg';
import rotateImg from './image/rotateicon.svg';
...
function controls(canvas: fabric.Canvas) {
  // 删除图标
